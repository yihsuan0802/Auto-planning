...
function SortableComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragover", function SortableComponent_div_1_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r236); const ctx_r235 = ɵngcc0.ɵɵnextContext(); return ctx_r235.onItemDragover($event, 0); })("dragenter", function SortableComponent_div_1_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r236); const ctx_r237 = ɵngcc0.ɵɵnextContext(); return ctx_r237.cancelEvent($event); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r231 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r231.placeholderClass)("ngStyle", ctx_r231.placeholderStyle);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r231.placeholderItem);
} }
...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r242); const item_r238 = ctx.$implicit; const i_r239 = ctx.index; const ctx_r241 = ɵngcc0.ɵɵnextContext(); return ctx_r241.onItemDragstart($event, item_r238, i_r239); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r242); const ctx_r243 = ɵngcc0.ɵɵnextContext(); return ctx_r243.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r242); const i_r239 = ctx.index; const ctx_r244 = ɵngcc0.ɵɵnextContext(); return ctx_r244.onItemDragover($event, i_r239); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r242); const ctx_r245 = ɵngcc0.ɵɵnextContext(); return ctx_r245.cancelEvent($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r232.itemClass, i_r239 === ctx_r232.activeItem ? ctx_r232.itemActiveClass : ""))("ngStyle", ctx_r232.getItemStyle(i_r239 === ctx_r232.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r239 === ctx_r232.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r232.itemTemplate || _r233)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r238, i_r239));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const item_r246 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r246.value);
} }
